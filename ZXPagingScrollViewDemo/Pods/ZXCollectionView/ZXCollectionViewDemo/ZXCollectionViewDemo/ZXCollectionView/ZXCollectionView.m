...
-(void)zx_fastWithModel:(ZXCVFastModel *)fastModel{
    ...
    if([self.collectionViewLayout isKindOfClass:[UICollectionViewFlowLayout class]]){
        ...
        if(fastModel.scrollDirection == ZXScrollDirectionVertical){
            ...
            CGFloat itemW = ((fastModel.superW ? fastModel.superW :self.frame.size.width) - (fastModel.colCount + marginOffset) * fastModel.margin) / fastModel.colCount - 0.01;
            CGFloat itemH = 0;
            ...
            CGFloat itemH = ((fastModel.superH ? fastModel.superH : self.frame.size.height) - (fastModel.rowCount + marginOffset) * fastModel.margin) / fastModel.rowCount - 0.01;
            CGFloat itemW = 0;
